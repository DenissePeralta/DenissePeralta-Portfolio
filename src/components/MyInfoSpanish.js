...
const MyInfoSpanish = () => {
    return (
        <section className="myInfoContainer">
            ...
            de la vida, obtener conocimientos en nuevos temas así como dominar algunas otras habilidades. Siempre busco trasladar las ideas en acciones 
            ...
            proporcionar soluciones digitales a algunos de los retos y desafíos que se viven día a día en la sociedad.`}</p>
        </section>
    );
  }
