...
const MyInfoSpanish = () => {
    return (
        <section className="myInfoContainer">
            ...
            campo de la tecnología como lo es la Inteligencia Artificial, nternet de las cosas, experiencia de usuario, diseño gráfico y desarrollo de software. Me encanta el 
