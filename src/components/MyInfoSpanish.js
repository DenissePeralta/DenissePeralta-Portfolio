...
const MyInfoSpanish = () => {
    return (
        <section className="myInfoContainer">
            ...
            campo de la tecnología como la Inteligencia Artificial, IoT, UX/UI, diseño gráfico y desarrollo de software. Me encanta el hecho de que puedo 
            usar mi creatividad para crear productos web innovadores y aplicaciones increíbles, con el fin de proporcionar 
            soluciones digitales a algunos de los retos y desafíos que se viven día a día en la sociedad, en la comunidad e incluso en el mundo. `}</p>
        </section>
    );
  }
